...
この小規模パックは、比熱比`gamma = 1.4`の等エントロピー面積–Mach数関係を確認するための小さな参照表と事前診断だけを提供します。
...
問い、面積関数、境界条件、比較条件、離散化、ソルバ構成、API、関数名、内部ファイル構成、評価指標、実験、図表、解釈は各プロジェクトで決めます。内部衝撃波を扱う場合も、まず等エントロピー縮小ケースを独立に検証してください。
