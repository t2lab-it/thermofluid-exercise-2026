...
学生用テンプレートは公開、最終プロジェクト用テンプレートも公開予定です（現時点では非公開）。個人課題用は学生が公開テンプレートの `Use this template` で自分のアカウントに作成し、SSHでcloneします。作成するリポジトリは公開します。LMSの成績・出欠・個別フィードバックなどの非公開データはGitに置きません。
